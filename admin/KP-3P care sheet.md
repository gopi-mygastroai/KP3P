...
4. The backend builds a KP-3P prompt and sends it to Anthropic Claude (`claude-sonnet-4-6`, streaming) using `ANTHROPIC_API_KEY` (same system prompt and PDF + patient text as before).
