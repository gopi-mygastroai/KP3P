...
export const patientDetailsViewStyles = `
  ...
  @media (max-width: 480px) {
    .pr-sidebar-column { grid-template-columns: 1fr; }
  }
  .pr-card {
    background: #fff;
    border: 0.5px solid #e2e8f0;
  ...
  .pr-card-head { display: flex; align-items: center; gap: 8px; padding: 10px 14px; background: #f8fafc; border-bottom: 0.5px solid #e2e8f0; min-width: 0; }
  ...
  .pr-card-title { font-size: 10px; font-weight: 700; color: #374151; letter-spacing: 0.07em; text-transform: uppercase; flex: 1; min-width: 0; }
  .pr-card-num { font-size: 10px; color: #cbd5e1; font-family: 'IBM Plex Mono', monospace; flex-shrink: 0; }
  .pr-field-grid {
    display: grid;
  ...
  @media (max-width: 540px) {
    .pr-field-grid { grid-template-columns: 1fr; column-gap: 0; }
  }
  .pr-field-section {
    grid-column: 1 / -1;
    margin: 4px 8px 8px;
  ...
  .pr-field { padding: 7px 8px; border-radius: 7px; transition: background 0.15s; min-width: 0; }
  ...
  .pr-field-value { font-size: 12.5px; color: #0f172a; line-height: 1.4; word-break: break-word; overflow-wrap: anywhere; }
  ...
  .pr-serology-pill { background: #f8fafc; border: 0.5px solid #e2e8f0; border-radius: 8px; padding: 8px 12px; min-width: 0; }
  ...
  .pr-serology-value { font-size: 12px; font-weight: 600; word-break: break-word; overflow-wrap: anywhere; }
  .pr-vaccine-grid {
    display: grid;
  ...
  .pr-status-badge { display: inline-flex; align-items: center; gap: 5px; padding: 3px 10px; border-radius: 20px; font-size: 11px; font-weight: 600; max-width: 100%; flex-wrap: wrap; }
  ...
  .pr-sidebar-big-val { font-size: 20px; font-weight: 700; margin-bottom: 3px; word-break: break-word; }
  .pr-sidebar-big-label { font-size: 10px; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.06em; word-break: break-word; }
  .pr-srow {
    display: grid;
  ...
  .pr-infection-row > span:last-child {
    min-width: 0;
    word-break: break-word;
    overflow-wrap: anywhere;
    text-align: right;
